...
void loop() {
    ...
    preveriTlak();
    long pot = 2110*pretvorba_poti;
    pot = 2100*pretvorba_poti;
    stepper.moveTo(pot);
    ...
    pot = 2120*pretvorba_poti;
    pot = 2110*pretvorba_poti;
    stepper.moveTo(pot);
...
void kalibracija(){
  ...
  lcd.print("Nastavi poteg na nulo");
  premor_do_zelenega_gumba();
  lcd.clear();
  ...
  //     }
  //     }
  // stepper.setCurrentPosition(-180); //koncno stikalo je pri -100
  // stepper.moveTo(0);
